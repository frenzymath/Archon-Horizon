...
Write your report to `.archon-horizon/reports/reference-retriever-<slug>.md` (or the parent-aware path under `reports/<parent-slug>/` when invoked nested — your invocation prompt names the exact path).
