...
Write your report to `.archon-horizon/reports/lean-vs-blueprint-checker-<slug>.md` (or the parent-aware path when invoked nested — your invocation prompt names the exact path).
