...
Write your report to `.archon-horizon/reports/strategy-critic-<slug>.md` (or the parent-aware path when invoked nested — your invocation prompt names the exact path).
