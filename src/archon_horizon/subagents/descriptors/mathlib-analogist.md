...
write_domain: "reports/**,analogies/**"
read_only: true
can_spawn: false
...
dispatcher_notes: |
  ...
  iters can read for the rationale, plus a report under `reports/`.
---
...
- `.archon-horizon/reports/mathlib-analogist-<slug>.md` (or the parent-aware path) — your report.
...
8. **Write the report** to `.archon-horizon/reports/mathlib-analogist-<slug>.md`.
...
9. **Write the persistent file** to `analogies/<slug>.md` and the report to `.archon-horizon/reports/mathlib-analogist-<slug>.md`. Format below — the cross-domain section is separate from the api-alignment section.
...
Write your report to `.archon-horizon/reports/mathlib-analogist-<slug>.md`.
