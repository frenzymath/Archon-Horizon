...
| 📐 [Blueprints & leandag](./blueprints-and-leandag/README.md) | Extracting LaTeX blueprints into dependency DAGs and querying cones with the `leandag` engine. | `horizon blueprint`, `horizon leandag` |
...
| `horizon leandag` | Query dependency cones and multi-project blueprint DAGs. |
